...
const AdvertizeBanner = () => {
  return (
    <section className="mt-24 container rounded-xl mx-auto bg-gradient-to-r from-[#EEEEEE] to-[#E0E1DC] flex flex-row items-center pt-24 pb-40 pr-28 relative">
      <div className="w-5/12   ">
        <img src={atvergizeImage} style={{filter: "drop-shadow(-16px -15px 4px rgba(0, 0, 0, 0.25))",}} className="absolute    bottom-0 left-0 w-[830px]" />
      </div>
      <div className="w-7/12 ">
        <div className="flex justify-end mb-2 flex-row items-center font-bold text-[68px] font-poppins">
        ...
        <div className="flex flex-row mt-6 ml-32 justify-center gap-1 items-center">
